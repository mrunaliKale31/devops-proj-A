  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'var(--success)', filter: 'blur(100px)', opacity: 0.15, borderRadius: '50%'
      }}></div>
      ...
      <div className="glass-panel animate-fade-in" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <div style={{
            ...
            margin: '0 auto 1.5rem', boxShadow: '0 8px 24px rgba(79, 70, 229, 0.4)'
          }}>
            <LogIn size={32} />
          </div>
        ...
        {error && (
          <div style={{
            background: 'var(--danger-bg)', color: 'var(--danger)', padding: '1rem',
